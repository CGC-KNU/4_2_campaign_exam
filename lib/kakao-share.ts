...
const FALLBACK_KAKAO_JAVASCRIPT_KEY = 'c9d852ce090e90ca460c2260d5f86bdc'
...
function getKakaoKey() {
  return process.env.NEXT_PUBLIC_KAKAO_JAVASCRIPT_KEY?.trim() || FALLBACK_KAKAO_JAVASCRIPT_KEY
}
